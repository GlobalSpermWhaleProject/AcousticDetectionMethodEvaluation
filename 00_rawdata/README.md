...
- 01_Results_WoS-search.csv: Primary search results exported from Web of Science database. Contains bibliographic information from Web of Science and manual filtering outcomes.
- 01_Results_Other.csv: Additional references identified through other sources (Google Scholar alerts, expert opinion, document references). 
...
See DATA_DICTIONARY.md for detailed variable descriptions.

## Notes

- Web of Science search was conducted on 2026-02-18
- Sample audio files used for method evaluation are stored externally to this repository due to file size constraints