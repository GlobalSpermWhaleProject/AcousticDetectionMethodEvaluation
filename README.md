...
- *00_rawdata*: Most raw data (sample audio files used for method evaluation) are house externally to the repository. However, this directory contains any raw data that is housed within the repository.
